 ...
 *
 * The slide show speed is specified with the folloging classe:
 ...
 *
 * The side of the slide show can be set by the sldie show element itself or by
...
function CS_bind_slideshow (slideshow) {
   ...
   * @param new_slide the index of the new slide to select,lide,
   * @return void.
   */
  function set_transition (slide_to_select, old_slide, new_slide) {
    ...
    /* for the modes that needs a tansition */
  ...
  else if (slideshow.binded == true) {
    return slideshow;
  }
  else {
    // mark the slideshow as binded
    slideshow.binded = true;
